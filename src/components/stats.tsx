      ...
      <section className="py-20 sm:py-28 bg-[#050505]">
        <div ref={ref} className="scroll-reveal mx-auto max-w-3xl px-4 sm:px-6">
          ...
          <p className="text-[15px] text-zinc-400 mb-8">
            ...
            diferente de qualquer codigo no GitHub.
          </p>
          ...
          <div className="rounded-xl border-l-[3px] border-green-500 bg-green-500/[0.06] p-8 mb-8">
            ...
            <p className="text-sm text-zinc-400 leading-relaxed mb-3">
              Voce pega o arquivo de guia, cola num chat de IA (Claude, ChatGPT,
            ...
            <p className="text-sm text-zinc-400 leading-relaxed mb-6">
              Ela da <strong className="text-white">um passo de cada vez</strong>.
              Espera voce confirmar que funcionou. Se der erro, pede o print e
              resolve. Nao avanca ate estar tudo certo. E como ter um professor
              particular que <span className="text-gradient-green font-semibold">nao desiste de voce.</span>
            </p>
          ...
          <div className="image-frame border border-white/8">
            <Image
              ...
              alt="Split screen: Claude guiando instalacao + terminal com JARVIS"
              width={1400}
              height={788}
