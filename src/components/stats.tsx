    ...
    <section className="py-20 sm:py-28">
      <div className="mx-auto max-w-3xl px-4 sm:px-6">
        <h2 className="font-heading text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight leading-tight mb-2">
          Nunca programou?
          <br />
          <span className="text-green-400">Perfeito.</span>
        </h2>
        ...
        <div className="rounded-xl border-l-[3px] border-green-500 bg-green-500/[0.06] p-8 mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              ...
              <div
                key={step.num}
                className="rounded-lg bg-black/30 p-4 text-center"
              >
                <div className="font-heading text-2xl font-bold text-green-400 mb-1">
                  {step.num}
                </div>
