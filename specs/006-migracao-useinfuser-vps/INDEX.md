...
|---:|---|---|---|---|---|---|
| 0 | [README.md](README.md) | verified | 1.2 | Yan | Codex /codar | Hotfix de transporte provado no booking real da KSG. |
...
| 3 | [CONTRATOS-E-EVENTOS.md](CONTRATOS-E-EVENTOS.md) | verified | 1.2 | Codex /event-driven | Codex /codar | Retry restrito e conexão descartável provados em produção. |
...
| 6 | [PLANO-DE-IMPLEMENTACAO.md](PLANO-DE-IMPLEMENTACAO.md) | verified | 1.2 | Codex /codar | Yan, pelo go explícito | Fatia W7 fechada no commit `2c4ddcf`. |
| 7 | [VERIFICACAO-E-OPERACAO.md](VERIFICACAO-E-OPERACAO.md) | verified | 1.2 | Codex /software-engineer | Codex /codar | Transporte, banco e Google Calendar aprovados. |
...
- [x] O `README.md` declara `definition_status: verified` após a prova real da fatia W7.
